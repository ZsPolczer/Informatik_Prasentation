    ...
    return (
        <section className="relative group mb-16">
            ...
            <div className="relative bg-[#0d1219]/95 backdrop-blur-xl border border-cyber-border rounded-xl p-6 md:p-8 shadow-2xl">
                ...
                {/* CENTER: NETWORK DIAGRAM (Now a full-width section above the interactives) */}
                ...
                <div className="grid grid-cols-1 xl:grid-cols-2 gap-12 items-start justify-items-center">
