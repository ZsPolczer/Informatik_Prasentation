...
const App: React.FC = () => {
  ...
  predict(inputs: number[]): number[] {
    ...
    return output;
      ...
      {/* --- SITE FOOTER --- */}
      <footer className="absolute bottom-4 left-4 md:left-8 z-20">
        <a
          href="https://github.com/ZsPolczer/Informatik_Prasentation.git"
          target="_blank"
          rel="noopener noreferrer"
          className="group flex items-center gap-2 bg-black/40 hover:bg-black/60 border border-cyber-border/50 hover:border-cyber-accent/50 p-2 rounded-lg backdrop-blur-sm transition-all duration-300"
        >
          <svg className="w-4 h-4 text-gray-400 group-hover:text-cyber-accent transition-colors" fill="currentColor" viewBox="0 0 24 24">
          ...
          <span className="text-[10px] font-mono text-gray-500 group-hover:text-white transition-colors">GitHub Repository</span>
        </a>
      </footer>
